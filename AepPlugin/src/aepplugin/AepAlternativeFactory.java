 ...
 * @author WatPowerUser
 */
public class AepAlternativeFactory extends AbstractNewObjectFactory  implements NewObjectFactory{
    private AepPlugin _plugin;
    public AepAlternativeFactory(AepPlugin plugin){
        super(AepPluginI18n.getI18n(AepPluginMessages.Bundle_Name));
        _plugin = plugin;
    }
    @Override
    ...
    public Object createObject(JComponent jc) {
        ...
        AepAlternative alt = new AepAlternative();
